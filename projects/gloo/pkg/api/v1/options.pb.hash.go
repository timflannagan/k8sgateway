...
// Hash function
func (m *RouteOptions_DirectResponseAction) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.RouteOptions_DirectResponseAction")); err != nil {
		return 0, err
	}
